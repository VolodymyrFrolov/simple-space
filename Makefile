SOURCES = main.cpp simplespace.cpp planet.cpp physics.cpp timer.cpp controls.cpp
...
main.o: src/main.cpp inc/simplespace.h inc/planet.h inc/physics.h inc/timer.h inc/controls.h
